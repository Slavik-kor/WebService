...
public class ServiceWSServiceLocator extends org.apache.axis.client.Service implements edu.epam.service.ws.ServiceWSService {
    ...
    private java.lang.String ServiceWSPort_address = "http://localhost:9080/WS/ServiceWSService";
    ...
    public edu.epam.service.ws.ServiceWS getServiceWSPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            edu.epam.service.ws.ServiceWSServiceSoapBindingStub _stub = new edu.epam.service.ws.ServiceWSServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (edu.epam.service.ws.ServiceWS.class.isAssignableFrom(serviceEndpointInterface)) {
                edu.epam.service.ws.ServiceWSServiceSoapBindingStub _stub = new edu.epam.service.ws.ServiceWSServiceSoapBindingStub(new java.net.URL(ServiceWSPort_address), this);
                _stub.setPortName(getServiceWSPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ws.service.epam.edu/", "ServiceWSService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ws.service.epam.edu/", "ServiceWSPort"));
        }
